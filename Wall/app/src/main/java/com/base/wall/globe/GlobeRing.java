...
public class GlobeRing extends BaseRenderable implements ColorChangedListener {
    ...
    public GlobeRing(Base base) {
        ...
        cr = new Colorf(1.0f, 1.0f, 1.0f, 1.0f);
    }

    @Override
    public void onColorChanged(Colorf color) {

        final float brightness = 1.25f;

        cr.r = color.r * brightness;
        cr.g = color.g * brightness;
        cr.b = color.b * brightness;
    }
